...
public class ClassUpdate { 
	...
	/*테스트*/
	@RequestMapping("/classLoaderTest") 
	public void classLoader() {
		...
		try {
	        ...
	        // 소스 코드를 메모리에 저장하는 FileObject 생성
			Iterable<? extends JavaFileObject> compilationUnits = fileManager.getJavaFileObjects(new File("D:\\SOURCE\\busan\\workspace\\SpringTilesProject\\src\\main\\java\\com\\web\\controller\\ViewController.java"));

            // 컴파일 실행
            compiler.getTask(null, fileManager, null, null, null, compilationUnits).call(); 
			*/        
            ClassLoaderForWas classLoader = new ClassLoaderForWas(ClassLoader.class.getClassLoader()
            		, "D:\\SOURCE\\busan\\workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp2\\wtpwebapps\\SpringTilesProject\\WEB-INF\\classes\\com\\web\\controller");
            
            Class<?> myClass = Class.forName("com.web.controller.ViewController");
            Object myClasaas = myClass.newInstance();
            System.err.println(myClasaas);
           
             

            // clearCache() 메서드가 private이므로, Reflection을 사용하여 호출합니다.
            java.lang.reflect.Method method = ClassLoaderForWas.class.getDeclaredMethod("clearCache", (Class[]) null);
            method.setAccessible(true); // private 메서드에 접근하기 위해 설정
