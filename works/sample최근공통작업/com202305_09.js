...
//#######################################################################
	...
	*/
	...
	urzzFunction.popupInfo = {
			  COM000063  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 900} , popkey  : { popkey : "COM000063key"} , title :  "**************서류" }  
			, COM000064  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 800} , popkey  : { popkey : "COM000064key"} , title :  "***조회" }  
			, COM000065  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 800} , popkey  : { popkey : "COM000065key"} , title :  "***검색" }  
			, COM000066  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 300} , popkey  : { popkey : "COM000066key"} , title :  "소비***" }  
			, COM000069  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 270} , popkey  : { popkey : "COM000069key"} , title :  "고객***입력" }  
			, COM000093  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "COM000093key"} , title :  "전자******조회" }  
			, COM000094  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 350} , popkey  : { popkey : "COM000094key"} , title :  "상품***************" }  
			, COM000100  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "COM000100key"} , title :  "*********" }  
			, COM010031  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 800} , popkey  : { popkey : "COM010031key"} , title :  "******" }  
			, CRD060115  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "CRD060115key"} , title :  "기************조회" }  
			, CRD060140  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CRD060140key"} , title :  "회원정보*********조회" }  
			, CRD060145  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CRD060145key"} , title :  "결제*********정보" }  
			, CRD060150  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "CRD060150key"} , title :  "카드*******검색" }  
			, CUS020204  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 470} , popkey  : { popkey : "CUS020204key"} , title :  "위임************" }  
			, CUS020205  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 470} , popkey  : { popkey : "CUS020205key"} , title :  "대리************" }  
			, CUS020207  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 470} , popkey  : { popkey : "CUS020207key"} , title :  "신분*********사유" }  
			, CUS020240  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS020240key"} , title :  "국가***조회" }  
			, CUS020241  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS020241key"} , title :  "직원******조회" }  
			, CUS020242  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS020242key"} , title :  "*********코드조회" }  
			, CUS020250  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS020250key"} , title :  "우편***조회" }  
			, CUS040106  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS040106key"} , title :  "카드상세정보조회" }  
			, CUS040110  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS040110key"} , title :  "과목코드조회" }  
			, CUS040115  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS040115key"} , title :  "고객상세정보조회" }  
			, CUS040120  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS040120key"} , title :  "고객검색" }  
			, CUS040131  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 350} , popkey  : { popkey : "CUS040131key"} , title :  "수수료거래별상세정보" }  
			, CUS050240  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050240key"} , title :  "고객분류코드" }  
			, CUS050245  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050245key"} , title :  "소득자구분" }  
			, CUS050250  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050250key"} , title :  "거래자구분코드" }  
			, CUS050255  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050255key"} , title :  "신BIS고객구분" }  
			, CUS050260  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050260key"} , title :  "국가코드조회" }  
			, CUS050265  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050265key"} , title :  "AML코드조회" }  
			, CUS050270  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "CUS050270key"} , title :  "표준산업분류코드조회" }  
			, CUS080104  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 470} , popkey  : { popkey : "CUS080104key"} , title :  "FATCA/CRS조작자확인사항" }  
			, DBI010216  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "DBI010216key"} , title :  "구속***스트" }  
			, DPS040230  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "DPS040230key"} , title :  "우대금리신청번호조회" }  
			, DPS050228  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "DPS050228key"} , title :  "우대금리신청번호조회" }  
			, DPS090110  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "DPS090110key"} , title :  "거래***세" }  
			, DPS090115  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "DPS090115key"} , title :  "고객별***조회" }  
			, DPS120255  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "DPS120255key"} , title :  "자기앞*********청" }  
			, DPS130233  : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 300} , popkey  : { popkey : "DPS130233key"} , title :  "해*********분선택" }   
			, PCOM020112 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020112Key"}, title :  "** 목록 조회" }  
			, PCOM020113 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020113Key"}, title :  "** 목록 조회" }  
			, PCOM020114 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020114Key"}, title :  "** 목록 조회" }  
			, PCOM020115 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020115Key"}, title :  "** 목록 조회" }  
			, PCOM020116 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020116Key"}, title :  "** 목록 조회" }  
			, PCOM020117 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020117Key"}, title :  "** 목록 조회" }  
			, PCOM020118 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020118Key"}, title :  "** 목록 조회" }  
			, PCOM020119 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020119Key"}, title :  "** 목록 조회" }  
			, PCOM020120 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020120Key"}, title :  "** 목록조회" }  
			, PCOM020121 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020121Key"}, title :  "**카드번호 **조회" }  
			, PCOM020125 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020125Key"}, title :  "**코드 목록 조회" }  
			, PCOM020126 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020126Key"}, title :  "** 목록 조회" }  
			, PCOM020127 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020127Key"}, title :  "** 조회" }  
			, PCOM020129 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020129Key"}, title :  "회원별 카드번호 조회" }  
			, PCOM020130 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020130Key"}, title :  "고객검색" }  
			, PCOM020131 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020131Key"}, title :  "** 목록 조회" }  
			, PCOM020132 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020132Key"}, title :  "** 코드조회" }  
			, PCOM020133 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020133Key"}, title :  "** 조회" }  
			, PCOM020501 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020501Key"}, title :  "** 등록" }  
			, PCOM020505 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 700} , popkey  : { popkey : "PCOM020505Key"}, title :  "**번호" }  
			, PCOM030104 : {pageUrl : "uri/***.xml", options : { width  : 1000 , height: 500} , popkey  : { popkey : "PCOM030104Key"}, title :  "출금연동**입력" }   
        };           
 	 // 콜백  
